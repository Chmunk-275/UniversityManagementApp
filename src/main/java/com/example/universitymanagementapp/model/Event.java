...
public class Event {
    ...
    public Event(String eventName, String eventCode, String eventDescription, Image eventHeaderImage,
                 String headerImagePath, String eventLocation, Date eventDateTime, int eventCapacity,
                 String eventCost, List<String> registeredStudents) {
